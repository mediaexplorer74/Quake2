...
namespace Quake2
{
    public class CImage
    {
        ...
        public void CreateLightmap(byte[] lmBuffer)
        {
            ...
            Windows.Graphics.Imaging.SoftwareBitmap vBitmap = new Windows.Graphics.Imaging.SoftwareBitmap
                (default,
                CSurface.BLOCK_WIDTH, 
                CSurface.BLOCK_HEIGHT);//, Windows.Graphics.Imaging.PixelFormat.Format32bppArgb);
            ...
            for (int y = 0; y < CSurface.BLOCK_HEIGHT; y++)
            {
                for (int x = 0; x < CSurface.BLOCK_WIDTH; x++)
                {
                    ...
                    //RnD
                    //vBitmap.SetPixel(x, y, /*Color.FromArgb(255, ColR, ColG, ColB)*/default);
                }
            }
            ...
            if (CProgram.gQ2Game.gCMain.r_writelightmap == true)
            {
                ...
                {
                    Lightmaps[Lightmaps.Count - 1].SaveAsPng(strm, /*vBitmap.Width*/default, /*vBitmap.Height*/default);
                }
        ...
        private MemoryStream LoadAsPNG(Stream strm, out int Width, out int Height)
        {
            ...
            try
            {
                ...
                ms = new MemoryStream();
                vBitmap.Save(ms, default);//ImageFormat.Png);
            }
            catch
            {
                ...
                //RnD
                vTargaImage.Image.Save(ms, default);//ImageFormat.Png);
            }
        ...
        private Texture2D LoadPCX(string FileName, out int Width, out int Height)
        {
            ...
            //RnD
            vBitmap = new Bitmap(ScaledWidth, ScaledHeight, default);//System.Drawing.Imaging.PixelFormat.Format32bppArgb);
            ...
            for (int y = 0; y < ScaledHeight; y++)
            {
                for (int x = 0; x < ScaledWidth; x++)
                {
                    ...
                    //RnD
                    vBitmap.SetPixel(x, y, default);//System.Drawing.Color.FromArgb(ColA, ColR, ColG, ColB));
                }
            }

            //RnD
            vBitmap.Save(ms, default);//System.Drawing.Imaging.ImageFormat.Png);
            ms.Seek(0, System.IO.SeekOrigin.Begin);
            ...
            //RnD
            Tex2D = default;//Texture2D.FromStream(CProgram.gQ2Game.gGraphicsDevice, ms, /*Scaled*/Width, /*Scaled*/Height, false);
        ...
        private STextureWAL LoadWAL(string FileName, out int Width, out int Height)
        {
            ...
            //RnD
            vBitmap = new Bitmap(Wal.OriginalWidth, Wal.OriginalHeight, default);
            ...
            //RnD
            vBitmap.Save(MemStream, default);//System.Drawing.Imaging.ImageFormat.Png);
            MemStream.Seek(0, System.IO.SeekOrigin.Begin);
        ...
        private STextureWAL LoadM8(string FileName, out int Width, out int Height)
        {
            ...
            MemStream = new System.IO.MemoryStream();
            vBitmap = new Bitmap(Wal.OriginalWidth, Wal.OriginalHeight, 
                default);
                //System.Drawing.Imaging.PixelFormat.Format32bppArgb);
        ...
        private Texture2D LoadPic(string FileName, out int Width, out int Height)
        {
            ...
            //RnD
            Tex2D = default;//Texture2D.FromStream(CProgram.gQ2Game.gGraphicsDevice, ms, ScaledWidth, ScaledHeight, true);
            ms.Dispose();//.Close();
            Tex2D.Name = FileName;
