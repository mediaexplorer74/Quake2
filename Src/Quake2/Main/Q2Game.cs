...
namespace Quake2
{
    ...
    /// </summary>
    public class Quake2Game : Microsoft.Xna.Framework.Game
    {
        ...
        private void DrawOverlayText(Vector2 Origin, string Text, Color TextColor)
        {
            ...
            Origin.X -= 1;
            Origin.Y -= 1;
            spriteBatch.DrawString(Font1, Text, FontPos, Color.Black, 0, Origin, 1.0f, 
                SpriteEffects.None, 0.5f);

            Origin.X += 1;
            Origin.Y += 1;
            spriteBatch.DrawString(Font1, Text, FontPos, TextColor, 0, Origin, 1.0f, 
                SpriteEffects.None, 0.5f);
        ...
        protected override void Initialize()
        {
            ...
            if (CConfig.GetConfigBOOL("Vertical Sync") == true)
            {
                ...
                gGraphicsDeviceManager.GraphicsDevice.PresentationParameters.PresentationInterval
        ...
        protected override void LoadContent()
        {
            ...
            if (CProgram.gQ2Game.gGraphicsDevice.GraphicsProfile == GraphicsProfile.HiDef)
            {
                ...
                // "Cannot mix shader model 3.0 with earlier shader models.
                // If either the vertex shader or pixel shader is compiled as 3.0, they must both be."
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            // we are drawing the overlay text here, because we don't want it to be
            // affected by postprocessing
