...
namespace Paloma
{
...

    {
        ...
        /// <summary>
        /// Jacques Krige : Added the ability to load the targa from a stream
        /// Creates a new instance of the TargaImage object with stream strm as the image loaded.
        /// </summary>
        public TargaImage(Stream strm) : this()
        {
            // load the file as stream
            if (strm != null && strm.Length > 0 && strm.CanSeek == true)
            {
                BinaryReader binReader = null;
                ...
                throw new Exception(@"Error loading file, could not read file from stream.");
        }
            ...
            if (binReader != null && binReader.BaseStream != null && binReader.BaseStream.Length > 0 && binReader.BaseStream.CanSeek == true)
            {
                ...
                if (this.objTargaFooter.ExtensionAreaOffset > 0)
                {
                    try
                    {
                        ...
                        //RnD
                        this.objTargaExtensionArea.SetKeyColor(Color.Red);//FromArgb(a, r, g, b));
                        ...
                        if (this.objTargaExtensionArea.ColorCorrectionOffset > 0)
                        {
                            ...
                            for (int i = 0; i < TargaConstants.ExtensionAreaColorCorrectionTableValueLength; i++)
                            {
                                ...
                                //RnD
                                //this.objTargaExtensionArea.ColorCorrectionTable.Add(Color.Blue);//FromArgb(a, r, g, b));
                            }
                        }
                    }
                    catch (Exception ex)
        ...
        private void LoadTGAImage(BinaryReader binReader)
        {
            ...
            if (this.objTargaHeader.ColorMap.Count > 0)
            {
                ...
                for (int i = 0; i < this.objTargaHeader.ColorMap.Count; i++)
                {
                        ...
                        this.objTargaExtensionArea.AttributesType == 1)
                    {
                        ...
                        //RnD
                        pal.Entries[i] = Color.Purple;//FromArgb(255, this.objTargaHeader.ColorMap[i].R, this.objTargaHeader.ColorMap[i].G, this.objTargaHeader.ColorMap[i].B);
                    }
                    else
                    {
            ...
            { // no color map
                ...
                if (this.objTargaHeader.PixelDepth == 8 && (this.objTargaHeader.ImageType 
                    == ImageType.UNCOMPRESSED_BLACK_AND_WHITE ||
                    this.objTargaHeader.ImageType == ImageType.RUN_LENGTH_ENCODED_BLACK_AND_WHITE))
                {
                    ...
                    {
                        //RnD
                        pal.Entries[i] = Color.Green;//.FromArgb(i, i, i);
                    }
    ...
    public class TargaHeader
    {
        ...
        //private System.Collections.Generic.List<System.Drawing.Color>
        private List<Color> cColorMap = new List<Color>();//<System.Drawing.Color>();
        ...
        /// </summary>
        //public System.Collections.Generic.List<System.Drawing.Color> 
    ...
    public class TargaExtensionArea
    {
        ...
        //RnD
        Color cKeyColor = Color.TransparentBlack;//.Empty;
        ...
        //private System.Collections.Generic.List<System.Drawing.Color> cColorCorrectionTable 
    ...
    static class Utilities
    {
        ...
        internal static Color GetColorFrom2Bytes(byte one, byte two)
        {
            ...
            //RnD
            return Color.ForestGreen;//.FromArgb(a, r, g, b);
        }
