...
namespace Quake2
{
    public class CMain
    {
        ...
        public void BuildWorldModel(string BSPFileName)
        {
            ...
            CQ2BSP.SWorldData.vbWorldSolid = new VertexBuffer(
                CProgram.gQ2Game.gGraphicsDevice, WorldVertexDeclaration, 
                vertbuffer.Count, BufferUsage.WriteOnly);

            CQ2BSP.SWorldData.vbWorldSolid.SetData(vertbuffer.ToArray());


            // set up world index buffers
            CQ2BSP.SWorldData.ibWorldSolid = new CModel.SMIndexBuffer[CQ2BSP.SWorldData.WorldLightmaps.Length,
                CQ2BSP.SWorldData.texinfo.Length];
